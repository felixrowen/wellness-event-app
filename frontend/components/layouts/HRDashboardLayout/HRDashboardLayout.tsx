...
export interface HRDashboardLayoutProps {
  children: ReactNode;
}

export const HRDashboardLayout = ({ children }: HRDashboardLayoutProps) => {
    ...
    <div className="flex items-center gap-3">
      ...
      {!collapsed && (
        <div className="flex flex-col">
          ...
          <span className="text-xs text-default-500">HR Portal</span>
        </div>
      )}
    </div>
  );
